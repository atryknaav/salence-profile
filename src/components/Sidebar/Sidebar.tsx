...
const Sidebar = () => {
  ...
  return (
    <div className="lg:w-[20vw] border-r-[1px] border-border lg:flex lg:flex-col hidden">
      <div
        className={`flex font-semibold text-3xl w-full h-[fit-content]  border-b-[1px] border-border rounded-br-3xl pb-4 items-center gap-3 hover:cursor-pointer select-none ${
      ...
      <div className="w-full h-[fit-content] -mt-[1px]  border-t-[1px] border-border rounded-tr-3xl dark:text-white flex flex-col gap-2">
        ...
        <p
          className={`p-2 duration-100 mr-4 rounded-xl text-lg hover:cursor-pointer select-none ${
            isDark
              ? "hover:bg-back-dark active:bg-active-dark"
              : "text-black hover:bg-slate-50 active:bg-slate-100"
          }}`}
        ...
        <p
          className={`flex gap-3 mb-5 p-2 duration-100 mr-4 rounded-xl text-lg hover:cursor-pointer select-none ${
            isDark
              ? "hover:bg-back-dark active:bg-active-dark"
              : "text-black hover:bg-slate-50 active:bg-slate-100"
          }`}
